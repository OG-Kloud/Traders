...
import static net.kloudspace.trades.util.Stacks.books;
...
public class CostMap {
	public static Map<ItemStack, Integer> stacks = new HashMap<ItemStack, Integer>();
	
	public static void costMap() {
	...
	static {
		...
		stacks.put(cake, 60);
		stacks.put(carrot, 2);
		stacks.put(chicken, 5);
		stacks.put(cookedBeef, 16);
		stacks.put(cookedChicken, 15);
		stacks.put(cookedFish, 22);
		stacks.put(cookedPorkchops, 21);
		stacks.put(cookies,1);
		stacks.put(fish, 7);
		stacks.put(melonslices, 9);
		stacks.put(mushroomStew, 20);
		stacks.put(porkchops, 8);
		stacks.put(potatoes, 3);
		stacks.put(pumpkinpie, 76);
		stacks.put(arrows, 4);
		stacks.put(woodAxe, 75);
		stacks.put(woodPick, 75);
		stacks.put(woodSpade, 75);
		stacks.put(woodHoe, 75);
		stacks.put(woodSword, 100);
		stacks.put(stoneAxe, 125);
		stacks.put(stoneHoe, 125);
		stacks.put(stonePick, 125);
		stacks.put(stoneSpade, 125);
		stacks.put(stoneSword, 150);
		stacks.put(ironAxe, 200);
		stacks.put(ironPick, 200);
		stacks.put(ironHoe, 200);
		stacks.put(ironSpade, 200);
		stacks.put(ironSword, 250);
		stacks.put(diamondAxe, 500);
		stacks.put(diamondHoe, 500);
		stacks.put(diamondPick, 500);
		stacks.put(diamondSpade, 500);
		stacks.put(diamondSword, 750);
		stacks.put(shears, 100);
		stacks.put(rottenFlesh, 11);
		stacks.put(string, 7);
		stacks.put(gunpowder, 14);
		stacks.put(bones, 16);
		stacks.put(leatherDrop, 19);
		stacks.put(eggs, 6);
		stacks.put(blazeRod, 35);
		stacks.put(blazePowder, 60);
		stacks.put(magma, 40);
		stacks.put(ender, 88);
		stacks.put(spiderEyes, 7);
//		stacks.put(witherBone, 20);
		stacks.put(witherSkull, 20);
		stacks.put(neatherStar, 200);
		stacks.put(diamonds, 600);
		stacks.put(iron, 240);
		stacks.put(gold, 260);
		stacks.put(emeralds, 24);
		stacks.put(coal, 6); //EntityPlayer
		stacks.put(sticks, 1);
		stacks.put(flint, 2);
		stacks.put(leather, 19);
		stacks.put(papers, 9);
		stacks.put(books, 18);
		stacks.put(spawnEggs, 2000);
		stacks.put(redstone, 4);
		stacks.put(glowstonedust, 6);
		stacks.put(leatherBoots, 200);
		stacks.put(leatherChest, 250);
		stacks.put(leatherHelm, 200);
		stacks.put(leatherLegs, 225);
		stacks.put(goldBoots, 300);
		stacks.put(goldChest, 350);
		stacks.put(goldHelm, 300);
		stacks.put(goldLegs, 325);
		stacks.put(ironBoots, 400);
		stacks.put(ironChest, 450);
		stacks.put(ironHelm, 400);
		stacks.put(ironLegs, 425);
		stacks.put(diamondBoots, 600);
		stacks.put(diamondChest, 650);
		stacks.put(diamondHelm, 600);
		stacks.put(diamondLegs, 625);
		stacks.put(chainBoots, 300);
		stacks.put(chainChest, 350);
		stacks.put(chainHelm, 300);
		stacks.put(chainLegs, 325);
	}
}
