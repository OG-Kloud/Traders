...
public class Reference {
    ...
    public static ResourceLocation getVillager(int i) {
		if(i == 6 || i == 11) { return farmer; }
		else if(i == 7 || i == 12) {return librarian; }
		else if(i == 8 || i == 13) { return priest; }
		else if(i == 9 || i == 14) { return blacksmith; }
		else if(i == 10 || i == 15) { return butcher; }
		else
