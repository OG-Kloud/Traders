package net.kloudspace.trades.inv;
...
public class NewMerchantGui extends GuiContainer
{
    ...
    private NewMerchantGui.MerchantButton field_147043_x;
    private NewMerchantGui.MerchantButton field_147042_y;
    private int field_147041_z;
    private String field_147040_A;
    private static final String __OBFID = "CL_00000762";

    public NewMerchantGui(InventoryPlayer p_i1096_1_, IMerchant p_i1096_2_, World p_i1096_3_, String p_i1096_4_)
    {
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_147043_x = new NewMerchantGui.MerchantButton(1, i + 120 + 27, j + 24 - 1, true));
        this.buttonList.add(this.field_147042_y = new NewMerchantGui.MerchantButton(2, i + 36 - 19, j + 24 - 1, false));
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
        ...
        if (flag)
        {
            ((NewMerchantContainer)this.inventorySlots).setCurrentRecipeIndex(this.field_147041_z);
    ...
    static class MerchantButton extends GuiButton
        {
            ...
            public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_)
            {
                if (this.visible)
                {
                    p_146112_1_.getTextureManager().bindTexture(NewMerchantGui.field_147038_v);
                    GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
